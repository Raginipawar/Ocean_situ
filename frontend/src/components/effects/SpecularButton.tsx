...
// Source: github.com/DavidHDev/react-bits, src/ts-default/Components/SpecularButton.
// Adapted here to add an optional `to` prop: when present it renders a
// react-router <Link> (for real internal navigation, not just onClick) with
// the exact same shader effect, instead of always rendering a <button>.
...
export interface SpecularButtonProps {
  ...
  /** Internal route to navigate to. When set, renders a <Link>, not a <button>. */
  to?: string;
}
...
const SpecularButton = ({
  ...
  if (to) {
    return (
      <Link ref={btnRef} to={to} onClick={onClick} className={sharedClassName} style={sharedStyle}>
        {fx}
        {label}
      </Link>
    );
